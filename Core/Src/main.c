...
void task_main_loop(void const * argument)
{
  ...
  /* Infinite loop */
	...
	while(check_valid == VALID_CHANNELS)
	{
		int rear_angles[VALID_CHANNELS];
		int front_angles[VALID_CHANNELS];
		...
		int front_PWM = determine_wing_angle(front_angles);
		int rear_PWM = determine_wing_angle(rear_angles);
